						...
						else
						{
							...
							if(perservertasks > 0 )
							{
								...
								if(temp.size() > 0)
								{
									...
									localtotalsize = localtotalsize - temp.size();//
								}
//								startpos = startpos + perservertasks;
							}
						}
