...
public class GenFileWork implements Runnable {
	...
	public GenFileWork(GenFileHelper genFileHelper, AtomicInteger count, BlockingQueue<FileSegment> queue,
			BlockingQueue<FileSegment> upqueue, CyclicBarrier barrier) {
		this.queue = queue;
			...
			try {
				...
				if (segment == null) {
					...
					if (genFileHelper.isforceStop()) {
						...
						segment.taskStatus.setErrorInfo("");
						break;
					}
