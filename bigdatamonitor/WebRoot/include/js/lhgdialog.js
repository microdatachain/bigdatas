...
function opdg(text) {
	  ...
	  var dg = new $.dialog({ id:'opdg', title:'', width:250, height:150, fixed:true, top:200, html:"<div style='text-align:center;padding-top:25px'>" + text + "</div>"}); 
	  dg.ShowDialog(); 
}

function opdgForOrder(text) {
	
	  var dg2 = new $.dialog({ id:'opdgForOrder', title:'', width:700, height:500, fixed:true, top:200, html:text});
	  dg2.ShowDialog(); 
}